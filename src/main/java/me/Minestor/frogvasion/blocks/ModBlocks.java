...
public class ModBlocks {
    ...
    public static final Block RUBBER_PLANKS = registerBlock("rubber_planks", new Block(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), ItemGroups.NATURAL);
    ...
    public static final Block KAURI_PLANKS = registerBlock("kauri_planks", new Block(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), ItemGroups.NATURAL);
    ...
    public static final Block BROMELIAD = registerBlock("bromeliad", new TallFlowerBlock(FabricBlockSettings.of(Material.REPLACEABLE_PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS).offsetType(AbstractBlock.OffsetType.XZ)), ItemGroups.NATURAL);
    public static final Block ORCHID = registerBlock("orchid", new FlowerBlock(ModEffects.IMPROVER, 3, AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS).offsetType(AbstractBlock.OffsetType.XZ)) , ItemGroups.NATURAL);
    ...
    public static final Block GREENWOOD_PORTAL = registerBlockNoItem("greenwood_portal", new GreenwoodPortalBlock(FabricBlockSettings.copyOf(Blocks.NETHER_PORTAL)));
    public static final Block FROG_FLAME = registerBlockNoItem("frog_flame", new FrogFlame(AbstractBlock.Settings.of(Material.FIRE, MapColor.DARK_GREEN).noCollision().breakInstantly().luminance((state) -> 15).sounds(BlockSoundGroup.WOOL)));
    ...
    private static void registerItem(String name, BlockItem block, ItemGroup tab) {
