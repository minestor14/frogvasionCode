...
import me.Minestor.frogvasion.blocks.entity.models.FrogvasiumDemolisherModel;
...
public class FrogvasiumDemolisherRenderer extends GeoBlockRenderer<FrogvasiumDemolisherBlockEntity> {
    public FrogvasiumDemolisherRenderer() {
        super(new FrogvasiumDemolisherModel());
    }
    @Override
    public void actuallyRender(MatrixStack poseStack, FrogvasiumDemolisherBlockEntity animatable, BakedGeoModel model, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
