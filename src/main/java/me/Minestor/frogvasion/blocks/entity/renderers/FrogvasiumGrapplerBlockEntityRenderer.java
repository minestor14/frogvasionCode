...
public class FrogvasiumGrapplerBlockEntityRenderer<T extends BlockEntity & FrogvasiumActiveBlock> implements BlockEntityRenderer<T> {
    private final ModelPart attacker;
    public FrogvasiumGrapplerBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
