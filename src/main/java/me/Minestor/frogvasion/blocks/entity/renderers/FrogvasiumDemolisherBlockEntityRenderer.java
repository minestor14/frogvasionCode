...
public class FrogvasiumDemolisherBlockEntityRenderer<T extends BlockEntity & FrogvasiumActiveBlock> implements BlockEntityRenderer<T> {
    private final ModelPart attacker;
    public FrogvasiumDemolisherBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
