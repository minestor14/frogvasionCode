...
public class FrogvasiumAttackerBlockEntityRenderer<T extends BlockEntity & FrogvasiumActiveBlock> implements BlockEntityRenderer<T> {
    private final ModelPart attacker;
    public FrogvasiumAttackerBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
