...
public class FrogHouseStructure extends Structure {
    public static final Codec<FrogHouseStructure> CODEC = RecordCodecBuilder.<FrogHouseStructure>mapCodec(instance ->
            ...
            ).apply(instance, FrogHouseStructure::new)).codec();
    ...
    public FrogHouseStructure(Structure.Config config, RegistryEntry<StructurePool> startPool,
    ...
    private static boolean extraSpawningChecks(Structure.Context context) {
        ...
        // Checks to make sure our structure does not spawn above land that's higher than y = 290
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!FrogHouseStructure.extraSpawningChecks(context)) {
        ...
        Optional<StructurePosition> structurePiecesGenerator =
                StructurePoolBasedGenerator.generate(
                        ...
                        StructurePoolAliasLookup.EMPTY); // Maximum limit for how far pieces can spawn from center. You cannot set this bigger than 128 or else pieces gets cutoff.
    ...
    public StructureType<?> getType() {
        return ModStructures.FROG_HOUSE; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
