...
public class BlackOrchidPedestalStructure extends Structure {
    public static final Codec<BlackOrchidPedestalStructure> CODEC = RecordCodecBuilder.<BlackOrchidPedestalStructure>mapCodec(instance ->
            instance.group(BlackOrchidPedestalStructure.configCodecBuilder(instance),
            ...
            ).apply(instance, BlackOrchidPedestalStructure::new)).codec();
    ...
    public BlackOrchidPedestalStructure(Config config, RegistryEntry<StructurePool> startPool,
    ...
    protected Optional<StructurePosition> getStructurePosition(Context context) {
        if (!BlackOrchidPedestalStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ModStructures.BLACK_ORCHID_PEDESTAL;
    }
